...
<html lang="en">
    ...
    <script>
        ...
        function updateWatchHands() {
            ...
            const hourRotation = (hours) * 15 + minutes / 2;
...
//            drawNumber(i, 60);
        ...
        for (var i = 1; i <= 24; i++) {
            drawNumber(i, 70, "0.7em", 15);
        }
        function drawNumber(text, r, size = "1em", rotation = 30) {
            var pos = getCoordinate(100, 100, rotation * i, r);
