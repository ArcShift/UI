...
<html lang="en">
    ...
    <body style="background-color: black">
        <div style="display: grid; place-items: center;">
            ...
            <rect x="100" y="13" width="16" height="24" transform="translate(-8, -12)" stroke="orange" stroke-width="2"
                  rx="3" ry="3" fill="none" text-anchor="middle" dominant-baseline="middle"/>
